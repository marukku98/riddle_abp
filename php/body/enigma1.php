...
<body>
    ...
    <div class="total">
        <div class="container first">
            ...
            <p class="font-letter font-size">El ataque a Pearl Harbor fue una ofensiva militar sorpresa efectuada por
            ...
            <div class="planify">
                ...
                <p class="font-letter font-size">El Almirante Isoroku Yamamoto a causa de una enfermedad no podrá
                    dirigir el ejército de japón contra la
                    guerra a EE.UU. Por eso tu, el
                    capitán Genda, te ha ordenado liderar el ataque y llevar a Japón a la victoria, todos dependen de
                    ti!</p>

                <p class="font-letter font-size">Esta es la carta que te ha dejado el almirante: </p>

                <button class="btn btn-secondary btn-sm carta" data-toggle="modal" data-target="#exampleModaal">Leer
                    carta del almirante</button><br><br>
            </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="exampleModaal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="container mw-100 col-xl-12 col-md-8 col-sm-4 mx-auto" id="contain" style="display:none;">
                            <section id="content" class="col">
                                <form action="">
                                    <h6>Carta del almirante Yamamoto al capitán Genda pidiéndole que estudie la
                                        viabilidad de un ataque
                                        aéreo a Pearl Harbor.</h6>
                                    Febrero de 1941.
                                    Dependiendo de los cambios que se produzcan en la situación internacional,
                                    podríamos vernos
                                    arrastrados a luchar con Estados Unidos. Si Japón y Estados Unidos fueran a la
                                    guerra, tendríamos
                                    que recurrir a una táctica radical… Deberíamos intentar, con toda la fuerza de
                                    nuestras Primera y
                                    Segunda Divisiones Aéreas, asestar un golpe a la flota estadounidense en Hawái, de
                                    forma, que
                                    durante un tiempo, Estados Unidos no pudiera avanzar hacia el Pacífico occidental.
                                    Nuestro objetivo
                                    sería un grupo de acorazados estadounidenses… No sería fácil llevar a cabo algo
                                    así. Pero estoy
                                    decidido a darlo todo para realizar este plan, supervisando yo mismo las divisiones
                                    aéreas. Me
                                    gustaría que investigara pormenorizadamente la viabilidad de un plan de estas
                                    características.
                                </form>
                            </section>
                        </div>
    ...
    <div class="mapa">
        ...
        <p class="font-letter font-size">Desencripta los mapas que te ha enviado el Contraalmirante Takijiro Onishi,
            para poder situaros y reconocer
            la zona!</p>
        <button class="btn btn-info fas fa-exclamation-circle" type="button" data-toggle="modal" data-target="#reglasModal">
            Reglas</button>
        ...
        <div id="engima1">
            ...
            <!-- Modal -->
            <div class="modal fade" id="pistaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
            ...
            <!-- Modal -->
            <div class="modal fade" id="pistaModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <!-- Modal -->
            <div class="modal fade" id="pistaModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="dismiss" class="btn btn-secondary btn-sm" name="completed"
            ...
            <!-- Modal -->
            <div class="modal fade" id="correcte" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="modal fade" id="finalModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Enhorabuena, has completado el juego! Ya puedes pasar a la siguiente pantalla para el 2
                            nivel.
                        </div>
                        <div class="modal-footer">
            ...
            <!-- Modal pistas -->
            <div class="modal fade" id="reglasModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <ul class="list-group list-group-flush font-letter">
                                ...
                                <li class="list-group-item">Uno de los mapas está encriptado de 3x3 y otro tiene más
                                    seguridad y es de 4x4.</li>
                                <li class="list-group-item">El primer mapa está programado para que en 25 segundos se
                                    reinicie si tardas mucho en
                                    desencriptarlo. ¿Eres lo suficientemente rápido?</li>
                                <li class="list-group-item">Arrastra las piezas para intercambiarlas y resuelve el
                                    puzzle!</li>
                            </ul>
                        </div>
                        <div class="modal-footer">
